...
#
#  mostly taken from here https://github.com/metebalci/pdftitle
#
...
class enhance_title_search(object):
    ...
    def get_title_from_io(self, pdf_io):
        ...
        if doc.is_extractable:
            ...
            for page in PDFPage.create_pages(doc):
                ...
                if current_page_number == self.PAGE_NUMBER:
            ...
            if self.ALGO == "original":
                ...
                for tfs_index in self.ELIOT_TFS:
    ...
    def get_title_from_file(self, pdf_file):
        with open(pdf_file, 'rb') as raw_file:
            return self.get_title_from_io(raw_file)
    ...
    def process(self, parameters=None, data=None):
        ...
        data['etl_enhance_title_search_b'] = False
        ...
        if not (contenttype == 'application/pdf' or filename.lower().endswith('.pdf')):
            data['etl_enhance_title_search_b'] = False
        ...
        try:
            title = self.get_title_from_file(filename)
        except Exception as e:
            data['etl_enhance_title_search_error'] = f"{e}"
            data['etl_enhance_title_search_b'] = False
            return parameters, data

        data['title_txt'] = title
        data['etl_enhance_title_search_b'] = True
